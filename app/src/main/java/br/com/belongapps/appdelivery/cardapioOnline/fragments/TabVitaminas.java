...
public class TabVitaminas extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mProgressBar = rootView.findViewById(R.id.progressbar_escolher_vitaminas);
        mDatabaseReference = FirebaseDatabase.getInstance().getReference().child("itens_cardapio").child("9");

        mVitaminasList = rootView.findViewById(R.id.list_vitaminas);
    ...
    public static class VitaminasViewHolder extends RecyclerView.ViewHolder {
        ...
        public VitaminasViewHolder(final View itemView) {
            ...
            mView = itemView;
            card_vitaminas = mView.findViewById(R.id.card_vitaminas);

        }

        public void setNome(String nome) {

            TextView item_nome = mView.findViewById(R.id.item_nome_vitamina);
        ...
        public void setDescricao(String descricao) {
            ...
            TextView item_descricao = mView.findViewById(R.id.item_desc_vitamina);
        ...
        public void setValorUnitarioEPromocao(double valor_unit, boolean status_promocao, double valor_promocional) {
            ...
            TextView item_valor_promo = mView.findViewById(R.id.item_valor_promo_vitamina);
            TextView item_valor_unit = mView.findViewById(R.id.item_valor_unit_vitamina);
        ...
        public void setImagem(final Context context, final String url) {
            final ImageView item_ref_image = mView.findViewById(R.id.img_vitamina);
        ...
        public void setStatus(int status, int permiteEntrega) {
            TextView item_status = mView.findViewById(R.id.status_vitamina);
