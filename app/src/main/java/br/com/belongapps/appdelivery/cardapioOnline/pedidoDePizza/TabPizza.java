...
public class TabPizza extends Fragment {
    ...
    public void selecionarItem(final TamPizza model){
        ...
        btConfirmTipoPizza.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), PizzaMetade1Activity.class);

                ItemPizza itemPizza = new ItemPizza();
                itemPizza.setTamanho(model.getNome());
                itemPizza.setTipo(tipoPizzaSelecionada);

                intent.putExtra("ItemPizza", itemPizza);
