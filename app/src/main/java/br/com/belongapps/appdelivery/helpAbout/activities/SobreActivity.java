...
public class SobreActivity extends AppCompatActivity {
    ...
    public void preencherOpcoesSobre(){
        ...
        OpcoesSobre opcoesSobre2 = new OpcoesSobre(R.drawable.ic_file, "Política de privacidade");
        OpcoesSobre opcoesSobre3 = new OpcoesSobre(R.drawable.ic_view_list, "Versão 1.0.0");
